...
import specilitiesSection from '../components/specilitiesSection.vue'
import bookingPromoSection from '../components/bookingPromoSection.vue'
import countSection from '../components/countSection.vue'
import workGridSection from '../components/workGridSection.vue'

import { useAuthStore } from '@/stores/auth'
import ConnectToAccess from '@/components/utils/ConnectToAccess.vue'
...
<template>
  <section>
    ...
    <HeroSection
      ...
      title="Beauty Salon"
      logoText="Kiki Secret"
      buttonText="View Our Services"
      creatorLink="#"
      creatorName="Colorlib.com"
    />
    ...
    <specilitiesSection id="specialities" />
      ...
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section ftco-animate text-center">
            ...
            <p>
              At Kiki's Secret, our experts don't just deliver services – they create an experience
              of relaxation, confidence, and elegance.
            </p>
          </div>
        </div>
        <div class="row">
    ...
    <!-- Afficher les cartes si l'utilisateur est connecté -->
    <section id="works"  class="ftco-section">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-2">Our Work</h2>
            <p>
              At Kiki's Secret, every style we create and every service we provide is a masterpiece
              crafted with passion and precision. From intricate braids to flawless makeup looks,
              our work speaks for itself.
            </p>
          </div>
        </div>
        <!-- Afficher le composant ConnectToAccess si l'utilisateur n'est pas connecté -->
        <ConnectToAccess v-if="!isLoggedIn" />
        <workGridSection v-else />
      </div>
    </section>
    ...
    <section class="ftco-section">
      <div class="container">
        <div class="row justify-content-center mb-5 pb-3">
          <div class="col-md-7 heading-section text-center ftco-animate">
            <h2 class="mb-4">Discover Our Gallery</h2>
            <p>
              Experience the artistry and passion behind our work through our curated gallery. Each
              image tells a story of creativity, precision, and elegance, reflecting our commitment
              to excellence.
            </p>
          </div>
        </div>
        <div class="row">
          <div class="col-md-4 ftco-animate">
            <a href="#" class="work-entry">
              <img src="/assets/images/back_08.jpg" class="img-fluid" alt="Colorlib Template" />
          ...
          <div class="col-md-4 ftco-animate">
            <a href="#" class="work-entry">
              <img src="/assets/images/back_06.jpg" class="img-fluid" alt="Colorlib Template" />
              <div class="info d-flex align-items-center">
                <div>
                  <div class="icon mb-4 d-flex align-items-center justify-content-center">
                    <span class="icon-search"></span>
          ...
          <div class="col-md-4 ftco-animate">
            <a href="#" class="work-entry">
              <img src="/assets/images/back_07.jpg" class="img-fluid" alt="Colorlib Template" />
              <div class="info d-flex align-items-center">
                <div>
                  <div class="icon mb-4 d-flex align-items-center justify-content-center">
                    <span class="icon-search"></span>
    ...
    <section id="contact" class="ftco-section ftco-appointment">
